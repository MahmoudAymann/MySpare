...
public class Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext()).load(R.drawable.car_outside).into(image1);
        image2 = rootView.findViewById(R.id.image_2);
        Picasso.with(getContext()).load(R.drawable.car_inside).into(image2);
        image3 = rootView.findViewById(R.id.image_3);
        Picasso.with(getContext()).load(R.drawable.car_mechanic).into(image3);
        image4 = rootView.findViewById(R.id.image_4);
        Picasso.with(getContext()).load(R.drawable.car_battery).into(image4);
